...
EdenChain is the engine behind the most dynamic enterprise blockchain infrastructure.
========================================================================================
...
EdenChain is scalable
-----------------------
Parallel execution through Namespace and Merkle Tree technology enables the platform to carry out a vast number of transactions simultaneously. A permissioned blockchain builds a trustworthy environment for smart contract execution through the use of nodes within each Namespace. 

Edenchain Intro Video
-----------------------
.. raw:: html
